...
const CodeBlocks: React.FC<CodeBlockProps> = ({
  ...
  return (
    <div className={`flex ${position} my-20 justify-between gap-10 flex-wrap px-3 lg:px-12`}>
      {/* Section 1 */}
      <div className="flex flex-col gap-8 lg:w-[50%]">
        {heading}
        <div className="text-gray-600 dark:text-gray-300 font-medium text-md lg:text-lg">
          {subheading}
        </div>
      ...
      {/* Section 2 */}
      <div className="relative bg-gray-900 shadow-[0_0_20px_0] shadow-[#67d4fc] text-white rounded-lg overflow-hidden lg:w-[500px] w-full">
        {/* Background Gradient */}
